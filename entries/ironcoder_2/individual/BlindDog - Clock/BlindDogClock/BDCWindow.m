/*
 *  BDCWindw.m -- a part of BlindDogClock.app
 * 
...
@implementation BDCWindow

// In Interface Builder we set BDCWindow to be the class for our window, 
// so our own initializer is called here.
...
// Therefore, controls in such windows won't ever be enabled by default.  
// Thus, we override this method to change that.
//
...
// Once the user starts dragging the mouse, we move the window with it. We do this 
// because the window has no title bar for the user to drag (so we have to implement 
// dragging ourselves)
//
