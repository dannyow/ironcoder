...
- (void)drawInContext:(CGContextRef) context withRect:(CGRect*) boxrect {
	...
	hourh = 30;
	minutex = boxx+10;
	minutey = boxy+minutew;
	minutew = 20;
	minuteh = 20;
	secondx = boxx+50;
	secondy = boxy+secondw;
	secondw = 10;
	secondh = 10;
	...
	CGContextFillRect(context, hourRect);
	//CGContextStrokePath(context);
	
	CGContextSetRGBFillColor(context, 1.0, 1.0, 1.0, 1);
	CGContextFillRect(context, minuteRect);
	//CGContextStrokePath(context);
	
	CGContextSetRGBFillColor(context, 0.76, 0.34, 0.28, 1);
